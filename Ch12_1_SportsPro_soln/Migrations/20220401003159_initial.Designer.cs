...
namespace Ch12_1_SportsPro_soln.Migrations
{
    ...
    [Migration("20220401003159_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ch12_1_SportsPro_soln.Models.Country", b =>
                {
            ...
            modelBuilder.Entity("Ch12_1_SportsPro_soln.Models.Customer", b =>
                {
            ...
            modelBuilder.Entity("Ch12_1_SportsPro_soln.Models.Incident", b =>
                {
            ...
            modelBuilder.Entity("Ch12_1_SportsPro_soln.Models.Product", b =>
                {
                    b.Property<int>("ProductID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Ch12_1_SportsPro_soln.Models.Registration", b =>
                {
                    b.Property<int>("CustomerID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ch12_1_SportsPro_soln.Models.Technician", b =>
                {
                    b.Property<int>("TechnicianID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Ch12_1_SportsPro_soln.Models.Customer", b =>
                {
                    b.HasOne("Ch12_1_SportsPro_soln.Models.Country", "Country")
                        .WithMany()
            ...
            modelBuilder.Entity("Ch12_1_SportsPro_soln.Models.Incident", b =>
                {
                    b.HasOne("Ch12_1_SportsPro_soln.Models.Customer", "Customer")
                        .WithMany()
                        .HasForeignKey("CustomerID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Ch12_1_SportsPro_soln.Models.Product", "Product")
                        .WithMany()
                        .HasForeignKey("ProductID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Ch12_1_SportsPro_soln.Models.Technician", "Technician")
                        .WithMany()
